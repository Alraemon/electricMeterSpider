...
'''
#for option in option_set
#   param=urllib.parse.urlencode(option[1])
param=urllib.parse.urlencode(option_set[0][1])
header={"Content-Type":"application/x-www-form-urlencoded","Accept":"text/plain"}
conn=http.client.HTTPConnection("202.120.163.129:88")
conn.request("POST","/Default.aspx",param,header)
